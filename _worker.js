...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'page Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'page Frag - Best Ping 💥';
...
const updateDataset = async (env, Settings) => {
    ...
    const proxySettings = {
        ...
        intervalMax: Settings?.get('fragmentIntervalMax') || '27',
